...
def test_record(aggr_record):
    ...
    return molGraph.largest_dimension
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o",
        "--output",
        default="/home/mattia/Documents/epoxy/crossLinkingAndGelationPoint/systems/large3/gelPoint/gelPointMeasurements1_2nsNptCuring",
    ...
    with open(dumpConnectivity, "r") as connectivity_file:
        with open(dumpTrajectory, "r") as trajectory_file:
            ...
            while True:
                ...
                if new_dim < curr_dim:
                    last_record.dump_to(
                        ["data/first_conn.dat", "data/first_traj.dat"])
                    next_record.dump_to(
                        ["data/second_conn.dat", "data/second_traj.dat"]
                    )
                    print(
